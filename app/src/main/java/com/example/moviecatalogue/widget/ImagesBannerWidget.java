...
public class ImagesBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.example.moviecatologue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.moviecatologue.EXTRA_TEXT";
